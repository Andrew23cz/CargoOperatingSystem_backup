...
namespace CargoOperatingSystem.Client.Static
{
    public static class DateRangeGenerator
    {
        ...
        public static DateRange ThisYearToDate(DateTime date)
        {
            DateRange range = new DateRange();

            range.Start = new DateTime(date.Year, 1, 1);
            range.End = date.AddDays(1);

            //Tuple<DateTime, DateTime> result = new Tuple<DateTime, DateTime>(range.Start, range.End);
            return range;
        }
        ...
        public static DateRange LastYearToDate(DateTime date)
        {
            DateRange range = new DateRange();
        ...
        public static DateRange ThisMonthToDate(DateTime date)
        {
            DateRange range = new DateRange();
        ...
        public static DateRange LastMonthToDate(DateTime date)
        {
            DateRange range = new DateRange();
        ...
        public static DateRange ThisWeekToDate(DateTime date)
        {
            DateRange range = new DateRange();
        ...
        public static DateRange LastWeekToDate(DateTime date)
        {
