...
{
    public class AgentSubmitHawb : BaseDomainModel
    {
        ...
        public int? AgentSubmitShipperId { get; set; }
        public virtual AgentSubmitShipper AgentSubmitShipper { get; set; }

        public int? AgentSubmitConsigneeId { get; set; }
        public virtual AgentSubmitConsignee AgentSubmitConsignee { get; set; }
    }
}
